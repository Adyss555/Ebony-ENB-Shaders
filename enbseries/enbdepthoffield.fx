...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Some light modifications done by Adyss
...
// Adyss == lazyAss ? "yes" : "still yes"
#define SamplerPoint  PointSampler
#define SamplerLinear LinearSampler
...
UI_BOOL(QualityBool,					"High Quality Mode",			false)
UI_BOOL(bADOF_AutofocusEnable,			"Enable Auto Focus",   			false)
UI_FLOAT_FINE(fADOF_ManualfocusDepth,	"Manual Focus Distance",		0.0, 1.0, 0.05, 0.001)
UI_WHITESPACE(1)
UI_FLOAT(fApterture,				 	"Aperture",  					0.7, 2.8, 2.0)
...
UI_FLOAT(fADOF_SmootheningAmount,		"Smoothen Amount",				0.0, 5.0, 0.0)
...
float4	PS_ReadFocus(VS_OUTPUT_POST IN) : SV_Target
{
	...
	{
		scenefocus = fADOF_ManualfocusDepth * 0.025;
	}
